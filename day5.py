...
for vent in vents:
    ...
    if start_x == end_x:
        ...
        grid[start_x, start_y : end_y + 1] = np.array(
            [i + 1 for i in grid[start_x, start_y : end_y + 1]]
        )
        # print(grid[start_x][start_y:end_y])
    if start_y == end_y:
        # print(grid[start_x:end_x][start_y])
        grid[start_x : end_x + 1, start_y] = np.array(
            [i + 1 for i in grid[start_x : end_x + 1, start_y]]
        )
